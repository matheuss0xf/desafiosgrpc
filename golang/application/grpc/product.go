...
import (
	...
	"github.com/matheuss0xf/desafiosgrpc/golang/application/grpc/pb"
	"github.com/matheuss0xf/desafiosgrpc/golang/application/usecase"
)
...
func (p *ProductGrpcService) CreateProduct(ctx context.Context, in *pb.CreateProductRequest) (*pb.CreateProductResponse, error) {
	product, err := p.ProductUseCase.CreateProduct(in.GetName(), in.GetDescription(), in.GetPrice())
	if err != nil {
